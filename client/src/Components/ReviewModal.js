...
function ReviewModal({ isOpen, onClose, bookingId, onReviewSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await bookingsAPI.addRating(bookingId, rating, review);
            if (response.success) {
                onReviewSuccess();
                onClose();
            } else {
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                ...
                >
                    <div className="p-6 border-b border-neutral-100 flex justify-between items-center bg-neutral-50">
                        <h2 className="text-xl font-bold text-neutral-900">Rate Your Service</h2>
                        <button
                            onClick={onClose}
